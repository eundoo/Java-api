...
public class StringApp2 {
	...
	public static void main(String[] args) {
		...
		String str3 = "My car is a red car";
		int index1 = str3.indexOf("car");
		int index2 = str3.lastIndexOf("car");
		System.out.println("첫번째 등장 위치: " + index1);		//3
		System.out.println("마지막번째 등장 위치 " + index2);	//16
		
		//String substring(int beginIndex)
		//지정된 위치에서 문자열의 끝까지 해당하는 문자열로 구성된 문자열을 반환한다.
		...
		String str7 = "My car is a red car";
		System.out.println("변경전 문자열: " + str7);
		String str8 = str7.replace("car", "house");
		System.out.println("변경후 문자열: " + str7);		//변경후 문자열: My car is a red car
		System.out.println("획득한 문자열: " + str8);		//획득한 문자열: My house is a red house
		//값이 복사되어서 변경한 문자로 바뀐거지 원본(str7)이 바뀌지는 않는다.
		
		//String toLowerCase(), String toUpperCase()
		//해당문자열을 소문자, 대문자로 바뀐 새로운 문자열을 반환한다.
		...
		System.out.println("소문자로 구성된 문자열: " + str10);
		
		//boolean starWith(String prefix), boolean endsWith(String suffix)
